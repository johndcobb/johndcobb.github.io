...
| Mountain | Empty 3 × 3 and 5 × 5 boards | Enter a whole number of grains (1–10,000) and drop the entire batch in the center. The board settles and reports spills automatically. Smaller safe piles and spills offer a retry; the largest safe pile completes the level. Board taps cannot add or select sand. |
