...
I am an NSF postdoctoral fellow with [Hal Schenck](http://webhome.auburn.edu/~hks0015/) at Auburn University. During Spring 2027, I will be a long-term visitor at the Institute for Computational and Experimental Research in Mathematics at Brown University for the program [Metric Algebraic Geometry: Going Global]((https://icerm.brown.edu/program/semester_program/sp-s27)). My research interests are primarily within algebraic geometry and commutative algebra, as well as their applications to data science and physics. 
