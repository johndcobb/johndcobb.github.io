---
layout: page
permalink: teaching/AlgebraFall2026
title: Intro to Abstract Algebra
class: class
---

# MATH 5310/6310: Introduction to Abstract Algebra I
![Connecting group inverses of ZZ_k](/images/projects/Modular_Inverse_Graph.png)
...
<div class="button-container" style="text-align: center">
    <a href="https://rksmvv.ac.in/wp-content/uploads/2021/04/David_S_Dummit_Richard_M_Foote_Abstract_Algeb_230928_225848.pdf" class="button" style="margin:5px">
    <i class="fas fa-book" aria-hidden="true"></i>
    Book
    </a>
    <a href="/intro-abstract-algebra-notes/" class="button" style="margin:5px">
    <i class="fa-solid fa-link"></i>
    Website
    </a>
    <a class="button" href="/intro-abstract-algebra-notes/algebraclassnotes.pdf" style="margin:5px">
...
- First, tests may include extra-credit parts for undergraduate students that are required for students enrolled for graduate credit. Instead of acting as extra credit, these will factor into their grade. These parts will generally ask for a more conceptual argument, a generalization of a theorem from class, a counterexample showing the necessity of a hypothesis, or a synthesis of multiple ideas from the course.
...
- [Dummit and Foote](https://rksmvv.ac.in/wp-content/uploads/2021/04/David_S_Dummit_Richard_M_Foote_Abstract_Algeb_230928_225848.pdf), which is the closest to the standard algebra textbook.
- [Notes by Eloisa Grifo](https://eloisagrifo.github.io/Teaching/algebra.pdf), a commutative algebraist at University of Nebraska.
- [An infinitely large napkin](https://venhance.github.io/napkin/Napkin.pdf) by Evan Chen, which is mostly an intuitive introduction.
...
- Fields medalist Richard Borcherds has an underappreciated youtube channel in which he teaches many standard graduate courses, including essentially this one.
A few good additions, assuming this is abstract/graduate algebra:
- [Keith Conrad’s expository papers](https://kconrad.math.uconn.edu/blurbs/) - excellent short notes on specific topics: quotient groups, Sylow theorems, irreducibility tests, finite fields, Galois theory, etc.
- [J.S. Milne’s course notes](https://www.jmilne.org/math/CourseNotes/) - concise graduate-level notes, especially useful for Group Theory and Fields and Galois Theory.
- [MIT OCW 18.703 Modern Algebra](https://ocw.mit.edu/courses/18-703-modern-algebra-spring-2013/) - has lecture notes, problem sets, and exams; good for extra practice.
- [Aluffi, Algebra: Chapter 0](https://bookstore.ams.org/gsm-104) - a more modern/category-flavored graduate text; good for students who want a different viewpoint from Dummit and Foote.
- [SageMath](https://www.sagemath.org/) and [GAP](https://www.gap-system.org/) - useful for experimenting with groups, permutations, finite fields, and examples.
